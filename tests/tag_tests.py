...
def test_ECTagDataStr_success():
    print(ECTagDataStr('test'))
    assert ECTagDataStr('test') == '\x06\x05test\x00'
...
def test_ECTagDataInt_uint64():
    print(ECTagDataInt(80000000000000000))
    assert ECTagDataInt(80000000000000000) == '\x05\x08\x01\x1c\x37\x93\x7e\x08\x00\x00'
